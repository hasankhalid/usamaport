  ...
  render () {
    return (
      <div>
        ...
        <AboutMethod challenge="Challenge" challengeDesc="Develop a comprehensive ethnography of paan (a local delicacy) consumers in the Lahore area and examine perceived link to expressions of masculinity." truth="Approach" truthDesc="Gather qualitative data on paan consumers to understand consumption scenarios" concept="Approach" conceptDesc="Use quantitative surveys to measure mental associations with masculinity expression" img={paanCover} title="" approachTitle="Approach" approach={[{title: 'Extensive fieldwork' , description: 'The project involved months of interviews with paan eaters across socioeconmic strata to develop a comprehensive ethnography of consumption patterns. The fieldwork took my team to all corners of the city to ensure we captured variations across consumption hotspots.', subdesc: '', img: paan1},{title: 'Survey analysis' , description: 'We took self-reported mental associations with a dose of skepticism, and designed surveys inspired by psychological research to create quantitative measurements of personas. This mixed-methods approach created a more robust research design.', subdesc: '', img: paan2},{title: 'Participant observation' , description: 'No ethnography is complete without a fun little dose of participant observation. We embraced the paan eating culture by trying it out whilst being surrounded by locals – to their great amusement.', subdesc: 'This willingness to ‘do’ instead of just ‘say’ defines my approach to qualitative research.', img: paan3}]} description="" aggTitle="Methodology" method={["Fieldwork", "Interviews", "Participant observation", "Artifact analysis", "Surveys"]} titleAgg="Impact" aggregate={["A first-of-its-kind mixed-methods study into paan consumption that was a valuable addition to the limited literature on the subject"]}/>
